import {Controller, Get, Inject, Logger, OnModuleInit, Scope,} from '@nestjs/common';
...
export class ModuleRefController implements OnModuleInit {
    ...
    private regularModuleTest(): void {
        ...
        this.logger.log(`Test 3: Is regular not scoped service the same: ${regularService1 === regularService2}`);
    }
}
